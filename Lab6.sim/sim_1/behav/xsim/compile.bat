...
REM
REM Generated by Vivado on Thu Nov 23 13:24:21 -0500 2023
...
echo "xvlog --incr --relax -prj Mode1_tb_vlog.prj"
call xvlog  --incr --relax -prj Mode1_tb_vlog.prj -log xvlog.log
