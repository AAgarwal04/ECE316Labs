...
REM
REM Generated by Vivado on Fri Sep 15 00:48:24 -0500 2023
...
echo "xvlog --incr --relax -prj tb_Mux4_vlog.prj"
call xvlog  --incr --relax -prj tb_Mux4_vlog.prj -log xvlog.log
