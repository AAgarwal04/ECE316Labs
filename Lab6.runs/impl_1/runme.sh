...
HD_PWD='C:/Users/Aryan/OneDrive/Desktop/ECE 316/Lab6/Lab6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Modes.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Modes.tcl -notrace
