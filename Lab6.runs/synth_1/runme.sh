...
HD_PWD='C:/Users/Aryan/OneDrive/Desktop/ECE 316/Lab6/Lab6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Modes.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Modes.tcl
